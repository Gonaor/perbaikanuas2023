...
# Block fungsi lainnya untuk membantu
...
9. Exit
""")
    pilih = input_of_options("Masukkan pilihan Anda : ", ["1a", "1b", "1c", "2a", "2b", "2c", "9"])

    if pilih == "1a":
        nama = input_normal("Masukkan nama kamu : ")
        alamat = input_normal("Masukkan alamat kamu : ")
        telepon = input_normal("Masukkan telepon kamu : ")
        ...
        hasil_cari = cari_anggota_by_id(id_dicari)
